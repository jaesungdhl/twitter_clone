...
const Navbar = (props) => {
    return (
        <nav class="navbar">
            <div class="navbar-container" id="password-reset-page-navbar">
                <ul class="navbar-nav">
                    <li class="nav-item"><a className="nav-link password-reset-page-nav-link disabled" href="#"><i class="fab fa-twitter icon-loginPage"></i>Password Reset</a></li>
                </ul>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span className="current-language password-reset-page-nav-link">English</span>
                    </a>
                    <div class="dropdown-menu" id="password-reset-page-language-dropdown" aria-labelledby="navbarDropdown">
